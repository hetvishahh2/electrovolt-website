    ...
    <div>
      ...
      <div className="solutions" >
        <nav className="navigation1" data-aos="fade-up">
          <a href="#car-charger" className='hii'>Car Charger</a>
          <a href="#bus-charger" className='hii'>Bus Charger</a>
          <a href="#truck-charger" className='hii'>Truck Charger</a>
        </nav>
        <section id="energy-service"  className="charger-section1" >
          <div className="intro" data-aos="fade-up">
            <div className="text-content">
              <h2 className='hii'>Energy as a Service</h2>
            </div>
          </div>
        </section>
        ...
        <section id="car-charger" className="charger-section">
          <div className="intro1"  data-aos="fade-up">
            <h2 className='hii'>Car Charger</h2>
          </div>
          <div className="fill-screen-image" style={{ backgroundImage: `url("/images/CAR.png")` }} data-aos="fade-up">
          </div>
          <div className="intro1"  data-aos="fade-up">
            <p className='hii'>At Electrovolt, we are committed to powering the future of transportation with clean and efficient energy. 
        ...
        <section id="bus-charger" className="charger-section">
          <div className="intro1"  data-aos="fade-up">
            <h2 className='hii'>Bus Charger</h2>
          </div>
          <div className="fill-screen-image" style={{ backgroundImage: `url("/images/BUS2.png")` }} data-aos="fade-up">
          </div>
          <div className="intro1"  data-aos="fade-up">
            <p className='hii'>Empower your electric buses with Electrovolt’s advance charging infrastructure. 
        ...
        <section id="truck-charger" className="charger-section">
          ...
          <div className="intro1"  data-aos="fade-up">
            <p className='hii'>For the heavy-duty demands of electric trucks,
